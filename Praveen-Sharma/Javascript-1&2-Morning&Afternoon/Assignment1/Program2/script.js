...
function even_highlight(){
    set_to_default();
    for (var n = 1; n <= 20; ++ n){
        if(n%2==0){
            var divs = 'dv'+n;
            document.getElementById(divs).style.backgroundColor = "#ccc";
        }
    }
    console.log("Even Highlighted");
}

function multiple_five_highlight(){
    set_to_default();
    for (var n = 1; n <= 20; ++ n){
        if(n%5==0){
            var divs = 'dv'+n;
    ...
    console.log("Multiple of 5 Highlighted");
}
...
function set_to_default(){
    for (var n = 1; n <= 20; ++ n){
        var divs = 'dv'+n;
        document.getElementById(divs).style.backgroundColor = "#40e915";
    }
    console.log("Rseseted Color");
}