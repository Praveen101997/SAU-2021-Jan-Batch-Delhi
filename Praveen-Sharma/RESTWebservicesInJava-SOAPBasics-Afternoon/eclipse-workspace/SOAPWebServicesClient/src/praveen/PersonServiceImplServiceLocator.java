...
public class PersonServiceImplServiceLocator extends org.apache.axis.client.Service implements praveen.PersonServiceImplService {
    ...
    private java.lang.String PersonServiceImpl_address = "http://localhost:8080/SOAPWebServices/services/PersonServiceImpl";
    ...
    public praveen.PersonServiceImpl getPersonServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            praveen.PersonServiceImplSoapBindingStub _stub = new praveen.PersonServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (praveen.PersonServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                praveen.PersonServiceImplSoapBindingStub _stub = new praveen.PersonServiceImplSoapBindingStub(new java.net.URL(PersonServiceImpl_address), this);
                _stub.setPortName(getPersonServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://praveen", "PersonServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://praveen", "PersonServiceImpl"));
        }
